...
data class NetworkEmbeddedContainer(var events:NetworkEventsContainer)
@JsonClass(generateAdapter = true)
data class NetworkEventsContainer(var eventList :List<NetworkEventDetails> )
